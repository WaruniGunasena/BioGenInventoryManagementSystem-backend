...
public class SupplierPaymentReportStrategy implements ReportStrategy {
    final private ReportRepository reportRepo;
    @Override public String getReportIdentifier() { return "SUPPLIER_PAYMENT"; }
    @Override public String getReportName() { return "Supplier Payment History Log"; }
    ...
    public List<Map<String, Object>> getReportData(Map<String, String> params) {
        ...
        return reportRepo.getSupplierPaymentLog(start.atStartOfDay(), end.atTime(23, 59, 59));
    }
