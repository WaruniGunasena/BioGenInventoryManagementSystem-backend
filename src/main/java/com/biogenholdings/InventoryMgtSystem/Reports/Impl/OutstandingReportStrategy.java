...
public class OutstandingReportStrategy implements ReportStrategy {
    final private ReportRepository reportRepo;
    @Override public String getReportIdentifier() { return "OUTSTANDING_REPORT"; }
    @Override public String getReportName() { return "Pending Invoice Outstanding Report"; }

    @Override
    public List<Map<String, Object>> getReportData(Map<String, String> params) {
        return reportRepo.getOutstandingReport();
    }
